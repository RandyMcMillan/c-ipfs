...
MODULES := blocks cid cmd commands core exchange importer ipld journal merkledag multibase pin repo flatfs datastore thirdparty unixfs routing dnslink namesys path util rbsr nostr main
